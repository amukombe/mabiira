...
class ManagersControllerTest < ActionController::TestCase
  ...
  test "should create manager" do
    assert_difference('Manager.count') do
      post :create, manager: { hashed_password: @manager.hashed_password, name: @manager.name, salt: @manager.salt }
    end
  ...
  test "should update manager" do
    put :update, id: @manager, manager: { hashed_password: @manager.hashed_password, name: @manager.name, salt: @manager.salt }
    assert_redirected_to manager_path(assigns(:manager))
  end
